...
bitstream-parser-cli: parser-lib
	$(CC) $(CFLAGS) -L. -L${XILINX_XRT}/lib -o bitstream-parser parser_cli.c -lparser -lxml2 -ljansson -lxrt_coreutil -pthread -lstdc++
...
axlf-parser:
	$(CXX) $(CXXFLAGS) -I${XILINX_XRT}/include -I/usr/include/libxml2 -c -o axlf_parser.o bitstream/axlf/axlf_parser.cpp # -lxrt_coreutil -pthread
